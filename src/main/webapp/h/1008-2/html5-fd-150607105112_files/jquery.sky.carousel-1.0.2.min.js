...
SKY.CarouselItem.prototype = {
    ...
    update: function() {
        ...
        SKY.Utils.has3dTransformationSupport() && (a += "perspective(300px) rotateY(" + this.x + "deg" +") rotateX(" + this.y/360 + "deg" +") translateZ(0)"),
        
        // SKY.Utils.has3dTransformationSupport() && (a += "perspective(300px) rotateY(0deg) rotateX(0deg) translateZ(0)"),
...
SKY.Carousel.prototype = {
    ...
    initConfigParams: function() {
        ...
        SKY.Utils.has3dTransformationSupport() && this.dom.items.css(SKY.Utils.getPrefixedProperty("transformOrigin"), "center " + Math.round(a.itemHeight / 2) + "px")
        // SKY.Utils.has2dTransformationSupport() && this.dom.items.css(SKY.Utils.getPrefixedProperty("transformOrigin"), "center " + Math.round(a.itemHeight / 2) + "px")
    },
    initEvents: function() {
...
window.Modernizr = function(a, b, c) {
    ...
    f.addTest = function(a, b) {
        if ("object" == typeof a) for (var d in a) v(a, d) && f.addTest(d, a[d]);
        else {
            a = a.toLowerCase();
            if (f[a] !== c) return f;
